<x-layouts.app title="Modifier RDV — OptiGest">
    ...
    <div style="max-width:60%; margin:0 auto;">
        ...
        <div style="display:flex; align-items:center; gap:16px; margin-bottom:32px;">
            ...
            <div>
                <h1 style="font-size:26px; font-weight:800; color:#0f172a; margin:0;">Modifier le rendez-vous</h1>
                <p style="font-size:16px; color:#94a3b8; margin:6px 0 0;">{{ $rendezVous->client->nom_complet }} — {{ $rendezVous->date }}</p>
            </div>
        </div>
            ...
            <div style="background:#fff; border-radius:18px; border:1px solid #bfdbfe; padding:28px; box-shadow:0 4px 14px rgba(29,78,216,0.07); margin-bottom:24px;">
                ...
                <div style="display:flex; flex-direction:column; gap:20px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
                        ...
                        <div>
                            <label style="display:block; font-size:15px; font-weight:600; color:#334155; margin-bottom:10px;">Statut <span style="color:#ef4444;">*</span></label>
                            <select name="statut"
                                    style="width:100%; height:50px; border-radius:12px; border:1.5px solid #bfdbfe; background:#f8fbff; padding:0 16px; font-size:16px; color:#0f172a; outline:none; box-sizing:border-box; font-family:'Plus Jakarta Sans',sans-serif;">
                                <option value="planifie" {{ old('statut', $rendezVous->statut)=='planifie'?'selected':'' }}>Planifié</option>
                    ...
                    <div>
                        ...
                        <textarea name="commentaire" rows="3"
                                  style="width:100%; border-radius:12px; border:1.5px solid #bfdbfe; background:#f8fbff; padding:14px 16px; font-size:16px; color:#0f172a; outline:none; resize:none; box-sizing:border-box; font-family:'Plus Jakarta Sans',sans-serif;">{{ old('commentaire', $rendezVous->commentaire) }}</textarea>
                    </div>
